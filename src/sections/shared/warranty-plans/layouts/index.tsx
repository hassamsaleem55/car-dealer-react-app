...
//           <div
//             key={index}
//             className="bg-white border border-primary/50 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col"
//           >
//             {/* Sticky Header */}
//             <div className="sticky top-30 z-10 bg-primary/50 px-5 py-4 border-b border-gray-100 rounded-t-2xl">
