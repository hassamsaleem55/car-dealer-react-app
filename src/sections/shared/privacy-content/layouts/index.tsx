        ...
        <div className="space-y-8">
          ...
          <div>
            <p className="text-lg leading-relaxed">
              At {dealerName}, we are committed to protecting your privacy and ensuring the security of your personal information. 
          ...
          <div>
            ...
            <p className="leading-relaxed mt-4">
              This information may include: name, email address, phone number, postal address, date of birth, 
              driver's license information, financial information for credit applications, and vehicle preferences.
            </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Communicate with you about our vehicles, services, and promotions</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              (e.g., payment processors, financing partners, warranty providers, IT services)</li>
              <li><strong>Business Partners:</strong> Manufacturers, lenders, and insurance companies involved 
              in your transaction</li>
          ...
          <div>
            ...
            <p className="leading-relaxed">
              ...
              traffic, and understand user preferences. You can control cookies through your browser settings, but 
