...
// }) {
//   return (
//     // <div className="flex flex-col md:flex-row justify-center p-4 gap-4"></div>
//     <div
//       className={`${
...
//     >
//       {/* LEFT COLUMN */}
//       {/* <aside className="col-span-12 lg:col-span-4 xl:col-span-3 rounded-xl shadow-md"> */}
//       <aside
//         className={`${
//           requestType === "vehicledetails"
//             ? `w-full md:w-2/5`
...
//           <div className="border border-t-0 border-gray-200 p-4 text-basicFont space-y-2">
//             <div>
//               <div className="flex">
