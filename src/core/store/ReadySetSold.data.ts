...
export const readySetSold = [
  {
    id: 1,
    tag: "Instant Evaluation",
    title: "Value your car",
    description:
      "Fill out the form and submit it to value your car or you can contact us to get the valuation right away.",
    imgSrc: `${imgBasePath}car-value.webp`,
  },
  {
    id: 2,
