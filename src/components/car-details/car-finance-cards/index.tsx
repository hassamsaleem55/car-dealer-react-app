...
export default function CarFinanceCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl md:shadow-md transition-all duration-300 p-6 flex flex-col gap-4 md:gap-6 hover:ring-2 hover:ring-primary/40 hover:ring-offset-2">
      {/* === Header === */}
