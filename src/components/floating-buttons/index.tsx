...
export function ScrollToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`scroll-to-top-btn ${!isVisible ? "hidden" : ""}`}
...
export function WhatsAppChatButton() {
  ...
  const phoneNumber = dealerData.ContactInfo.WhatsAppNumber || "";
  const encodedMessage = encodeURIComponent("Hi! I'm interested in your cars.");
